...
OBJS_DEBUG := $(patsubst ./src/%, build/%, $(patsubst src/%, build/%, $(SRCS_DEBUG:.cc=.o)))
...
OBJS_CTEST := $(OBJS_TRACE) $(OBJS_DEBUG) $(OBJS_CACHE) $(OBJS_PMEM)
...
build/tests/cacheTest/%: $(OBJS_TRACE) $(OBJS_DEBUG) $(OBJS_CACHE) $(OBJS_PMEM) build/tests/cacheTest/%.o
	$(CXX) $(CXXFLAGS) $^ -o $@
...
test-cache: cachetest
	...
	@echo ""
	@echo "========================================"
	@echo "Timing tests (assoc=1)..."
	@echo "========================================"
	@./build/cachetest-timing --assoc 1
	@echo ""
	@echo "========================================"
	@echo "Timing tests (assoc=2)..."
	@echo "========================================"
	@./build/cachetest-timing --assoc 2
	@echo ""
	@echo "========================================"
	@echo "Timing tests (assoc=4)..."
	@echo "========================================"
	@./build/cachetest-timing --assoc 4
	@echo ""
	@echo "========================================"
	@echo "Multiple cache arbiter tests..."
	@echo "========================================"
	@./build/cachetest-multiple
